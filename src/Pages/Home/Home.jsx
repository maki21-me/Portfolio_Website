...
import ProfileLight from "../../assets/Images/dv.jpg";
import ProfileDark from "../../assets/Images/ph.jpg";
import Back from "../../assets/Images/black.jpg";
...
export default function Home() {
  return (
    ...
    >
      ...
      {/* CENTERED CONTENT - FAR FROM EDGES */}
          ...
          >
            <div
              className="
                ...
                shadow-[0_0_90px_-20px_rgba(0,0,0,0.4)]
            ...
            >
              <img
                src={ProfileLight}
                alt="Profile Light"
                className="w-full h-[360px] object-cover dark:hidden"
              />
              <img
                src={ProfileDark}
                alt="Profile Dark"
                className="w-full h-[360px] object-cover hidden dark:block"
              />
            </div>
          </motion.div>
